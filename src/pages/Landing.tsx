...
export const Landing = () => {
  return (
    <div className='relative min-h-screen w-full overflow-hidden bg-[#021733] '>
       ...
       <div className='absolute right-0 top-0 h-full w-1/2 rounded-l-[50%] bg-[#D2FAFC] [clip-path:ellipse(80%_70%_at_100%_50%)]'></div>
          ...
          <div className='ml-15'> 
            ...
            <Text variant={'h1'} className='text-[#2D99AE] text-6xl mt-3 '>better Living.</Text>
