...
const handleCardClick = () => {
  ...
  const handleEdit = (
    ...
    navigate(`/list/${shoppingList.id}/edit`, {
      state: shoppingList,
    });
  };
  ...
  return (
    <div
      className="rounded-4xl p-8 mt-5 w-70 h-70 border border-gray-300 xl"
      onClick={handleCardClick}
    >
      <div className="p-2">
        <Text
          variant={"h2"}
          className="font-bold text-2xl text-[#001C44]"
        >
        ...
        <Text
          variant={"p"}
          className="p-2 text-[#001C44]"
        >
          {shoppingList.numberOfItem}items
        </Text>

        <Text
          variant={"p"}
          className="text-[#001C44]"
        >
